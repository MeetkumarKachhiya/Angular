...
@Component({
  selector: 'app-emp-basic-info-save',
  templateUrl: './emp-basic-info-save.component.html',
  styleUrls: ['./emp-basic-info-save.component.css']
})
export class EmpBasicInfoSaveComponent implements OnInit {
  ...
  AddEmpData() {
    ...
    empModelObj.append('firstName', this.empBasicInfo.value.firstName)
    empModelObj.append('middleName', this.empBasicInfo.value.middleName)
    empModelObj.append('lastName', this.empBasicInfo.value.lastName)
    empModelObj.append('p_Mobile', this.empBasicInfo.value.p_Mobile)
    empModelObj.append('gender', this.empBasicInfo.value.gender)
    empModelObj.append('p_Email', this.empBasicInfo.value.p_Email)
    ...
    this.adminLayoutService.SaveUserBasicInfoMaster(empModelObj).subscribe((empData: any) => {
      // debugger
  ...
  editEmpData() {
    if (this.empId != "0") {
      ...
      this.adminLayoutService.getBasicDetailsByEmployeeID(empId).subscribe((Response: any) => {
        ...
        this.empBasicInfo.controls.firstName.setValue(Response.data.firstName)
        this.empBasicInfo.controls.middleName.setValue(Response.data.middleName)
        this.empBasicInfo.controls.lastName.setValue(Response.data.lastName)
        this.empBasicInfo.controls.p_Mobile.setValue(Response.data.p_Mobile)
        this.empBasicInfo.controls.gender.setValue(Response.data.gender.toString())
        this.empBasicInfo.controls.p_Email.setValue(Response.data.p_Email)
