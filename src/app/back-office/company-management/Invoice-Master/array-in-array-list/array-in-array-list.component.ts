...
@Component({
  selector: 'app-array-in-array-list',
  templateUrl: './array-in-array-list.component.html',
  styleUrls: ['./array-in-array-list.component.css']
})
export class ArrayInArrayListComponent implements OnInit {
